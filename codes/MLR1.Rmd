...
fin_df <- filter(fin_df, 
                 coalesce(retire_invst_num,0)>1200 & 
                 coalesce(retire_invst_num,0)<10000000)

fin_df <- fin_df %>% mutate(retire_invst_num = log(retire_invst_num))
...
fin_df <- fin_df %>% 
  mutate(fin_indy_inst_amount = 
         ...
         fin_indy_inst_amount = ifelse(fin_indy_inst_amount==0, mean(fin_indy_inst_amount), fin_indy_inst_amount))
